  ...
  <div className="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
    <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
      <div className="sm:max-w-lg">
        <h2 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Summer styles are finally here</h2>
      ...
      <div>
        <div className="mt-10">
          ...
          <Link href="/shop" className="inline-block rounded-md border border-transparent bg-[#e4a22f] px-8 py-3 text-center font-medium text-white hover:bg-[#e4a22fde]">Shop Collection</Link>
        </div>
      </div>
    </div>
  </div>
